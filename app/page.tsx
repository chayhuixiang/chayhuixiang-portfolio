    ...
    <main className="relative">
            ...
            <div className="flex flex-col gap-7 sm:gap-9 relative">
              <div className="flex md:gap-10 sm:justify-between md:justify-start">
                <div className="flex flex-col sm:gap-6 gap-5 items-center sm:items-start m-auto sm:m-0">
                  <h4 className="font-secondary text-base leading-tight sm:leading-normal sm:text-xl">
                    Hi everyone,
                  </h4>
                  <div>
                    <h1 className="text-3xl sm:text-4xl">I’m Hui Xiang.</h1>
                    <h1 className="text-3xl sm:text-4xl mt-2 sm:mt-0">
                      I code & I build!
                    </h1>
                  </div>
                  <ButtonGroup />
      ...
      <section className="bg-zinc-100 w-full dark:bg-purple-dark">
        <div className="w-full max-w-7xl py-5 sm:pt-16 m-auto sm:pb-20 flex flex-col items-center px-4 sm:px-[3rem]">
          <h1 className="text-center text-[1.75rem] sm:text-[2.5rem] leading-tight sm:leading-normal">
            How I can contribute
          </h1>
          <p className="mt-4 sm:mt-9 text-center w-full max-w-[39.1rem]">
            <span className="hidden sm:inline-block">
              My years of tinkering in science, research and programming have
              deeply fuelled my passion for software development and computer
              science (CS).
            </span>{" "}
            Here is my software skillset, and some of the technologies that I
            have worked with.
          </p>
