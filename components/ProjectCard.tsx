...
const ProjectCard = ({
  ...
  return (
    <article
      className={`w-full flex items-center flex-col rounded-xl p-4 sm:p-0 bg-zinc-100 dark:bg-purple-dark dark:sm:bg-transparent sm:bg-transparent ${
    ...
    >
      ...
      <div
        className={`w-full sm:w-[40.375rem] flex flex-col items-center ${
          !left
            ? "sm:items-end sm:pr-8 sm:pl-[5.125rem]"
            : "sm:items-start sm:pl-8 sm:pr-[5.125rem]"
        } pt-4 sm:py-7 gap-3 sm:gap-4 transition-all duration-200 bg-zinc-100 dark:bg-purple-dark sm:hover:shadow-around-lg ${
          !left ? "sm:ml-[-3.125rem]" : "sm:mr-[-3.125rem]"
        }`}
      >
            ...
            <img
              src={
                mounted && currentTheme === "dark"
                  ? stack.logo_path_dark
                  : stack.logo_path_light
              }
              alt="stack_logo"
              key={i}
        ...
        >
          {parsedDescription.map((descriptionChunk, i) =>
            i % 2 ? (
